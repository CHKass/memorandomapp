...
// Events
	events() {
		...
		// Because there is only one parameter in the arrow function (e) the parentheses are not actually required (but I am leaving them anyway)
			e.preventDefault()
...
// Methods
	...
	usernameImmediately() {
		if (this.username.value != "" && !/^([a-zA-Z0-9]+)$/.test(this.username.value)) {
			this.showValidationError(this.username, "Username can only contain letters or numbers")
		}
